    ...
    <div className="App">
      ...
      <Routes>
        ...
        <Route
          ...
          path="/rank"
          // element={ <Auth />}
          element={user ? <Navigate to="/ranking" /> : <Auth />}
        />
        <Route
          exact
          path="/newUserSetting"
        ...
        <Route
          ...
          path="/profile"
          element={
            user ? <Profile socket={socket} /> : <Navigate to="/login" />
          }
        />
        ...
        <Route
          ...
          element={
            user ? (
              <UserProfile className="ProfileProphecy" />
            ) : (
              <Navigate to="/login" />
            )
          }
